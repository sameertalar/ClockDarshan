    ...
    function setWaveParams() {
      ...
      if(window.screen.width < 600)
      {
        ...
        document.getElementById("screenSize").innerHTML ='Screen:' + window.screen.width +'X'+ window.screen.height+ ' Browser:' +window.innerWidth + 'X' + window.innerHeight;
    ...
    function showCurrentWave() {
        ...
        c.fillRect(FOCUS_LEFT,
            hMin - FOCUS_RADIUS - FOCUS_LINE / 2,
            FOCUS_DIAM,
            FOCUS_DIAM); // remove the previous focus circle
        c.fillRect(FOCUS_LEFT,
...
function displayTimeElasped() {
    ...
    document.getElementById("timeElasped").innerText = hours + ":" + minutes + ":" + seconds;
