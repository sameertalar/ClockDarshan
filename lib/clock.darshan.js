$(document).ready(function () {
  ...
  $("#currentQuarter").on("click", btnErrorMessageClick);
  ...
  function showCurrentSelection() {
    ...
    $("#currentQuarter").html(getCurrentTrackerTime());

    /*
    if($("#currentQuarter").html() === $("#errorMessage").html())
    {
      $("currentQuarter").removeClass("bg-danger");
      $("currentQuarter").addClass("bg-success");
    }
    else{
      $("currentQuarter").removeClass("bg-danger");
      $("currentQuarter").addClass("bg-success");
  ...
  function showCurrentTimeLeft(hours, min, sec) {
    ...
    var timeNow = pad(15 - (min % 15), 2) + ":" + pad(60 - sec, 2);
  ...
  function getCurrentTrackerTime() {
    ...
    return (h % 12 || 12).toString().padStart(2, "0") + "-" + quarter;
  }
  ...
  function setTracketSelect(id) {
    ...
    $("#selectTrackerTime").val(
      $("#hiddenTime" + id.replace("chunkLablelH", "")).val()
    );
