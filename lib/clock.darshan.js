$(document).ready(function () {
  ...
  function checkboxSoundsMuteChanged() {
    if ($("#checkboxSoundsMute").is(":checked")) {
      pauseAllAudios();
    } else {
    }
  }
  ...
  function page_Load() {
    ...
    for (let n = 0; n < 24; ++n) {
      $("#selectHour").append($("<option></option>").attr("value", n).text(n));
    }
    ...
    $("#btnTrackerCollapse").on("click", setTrackerTime);
    $("#clockContainer").on("click", oneClickTracker);
    ...
    $("#audioMeditation").attr("src", MEDIA_ROOT + "saregama18SecLow.wav");
    ...
    $("#radioMeditationMusic18Low").val(MEDIA_ROOT + "saregama18SecLow.wav");
  ...
  $("#checkboxSoundsMute").change(checkboxSoundsMuteChanged);
  ...
  function postToGoogle() {
    ...
    $.ajax({
      ...
      success: function (data, textStatus, xhr) {
        ...
        showAlert("<h2>" + data + "</h2>" + selection);
