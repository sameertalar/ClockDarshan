$(document).ready(function () {
  ...
  function updownArrow(down) {
    ...
    let seltext = selectedPeriod.text();

    if(down)
    {
      $("#selectTrackerTime").val(parseInt(selectedPeriod.val())+1);
     // let deg2 = getOnePointerDegree(parseInt(seltext[0])+1, parseInt(seltext[1])*15);
