    ...
    $.ajax({
      ...
      success: function (data, textStatus, xhr) {
        ...
        for (let i = 0; i < data.length; i++) {
          ...
          $("#chunkLablelH"+ (i+1)).html(data[i].h);
          $("#chunkLablelE"+ (i+1)).html(data[i].e);
          $("#chunkLablelW"+ (i+1)).html(data[i].w);
          $("#chunkLablelM"+ (i+1)).html(data[i].m);
          $("#hiddenTime"+ (i+1)).val(data[i].h2+"-"+data[i].q);
