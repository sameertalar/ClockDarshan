$(document).ready(function () {
  ...
  const __Configuration = {
    mind: [
      ...
      { icon: "❌" ,fa:"fa fa-circle-thin  text-secondary"},
    ...
    work: [
      { title: "Spiritual", column: "C", icon: "🪔" ,fa:"fa fa-eercast text-info"},
      { title: "Value Add", column: "D", icon: "💎" ,fa:"fa fa-diamond  text-primary"},
      { title: "Health", column: "E", icon: "🌿" ,fa:"fa fa-envira  text-success"},
